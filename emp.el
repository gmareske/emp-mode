...
(defun find-mpris-player ()
  "Returns a list of running MPRIS-compatible players"
  (let ((players
...
(defun mpris-call (interface method &rest args)
  "Calls #method with #interface on the MPRIS object specified by the custom variable mpris-service and returns the result"
  ;; synchronous
...
(defun metadata-hash ()
  "Returns a hash table of symbols of MPRIS properties to string values"
